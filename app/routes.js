...
export function setup(router) {
    router
        ...
        .get('/getAllReservationsJEmployeeJMembersJCar_washJType_carJPosition', multi_joinController.getAllReservationsJEmployeeJMembersJCar_washJType_carJPosition)
