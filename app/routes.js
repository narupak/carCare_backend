...
export function setup(router) {
    router
        ...
        .get('/getMemberWcid', memberController.getMemberWcid)
        ...
        .post('/getPromotionByDate', promotionController.getPromotionByDate)
        ...
        .get('/getAllCar_detailOrderByBrandApi', multi_joinController.getAllCar_detailOrderByBrandApi)
        .get('/getCar_detailWSize/:id', multi_joinController.getCar_detailWSize)
        .get('/getCar_detailWSizeApi/:id', multi_joinController.getCar_detailWSizeApi)
        .get('/getCar_detailWId/:id', multi_joinController.getCar_detailWId)
        .get('/getCar_detailWIdApi/:id', multi_joinController.getCar_detailWIdApi)
        ...
        .post('/getAllReservationWReport', multi_joinController.getAllReservationWReport)
        .post('/getAllReservationWReportSelectMonth', multi_joinController.getAllReservationWReportSelectMonth)
